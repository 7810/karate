<!--
Nom du fichier: haut_prof.php
Auteur: Julie STEPHANT
Date de création: 25/04/23
//_____________________________________________
//_____________________________________________
DESCRIPTION:
Template haut de la page de l'espace privé des professeurs
-->
                ...
                <div class="col-lg-8">
                    <div class="header__nav">
                        <nav class="header__menu mobile-menu">
                            <ul>
                                <li class="active"><a href=<?php echo base_url()."index.php/professeur/profil/"?>>Mon profil</a></li>
                                <li ><a href=<?php echo base_url()."index.php/professeur/list_profils/"?>>Tous les profils</a></li>
                                <li ><a href=<?php echo base_url()."index.php/publication/afficher_prof/"?>>Publications</a></li>
