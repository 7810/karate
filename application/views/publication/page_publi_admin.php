<!--
Nom du fichier: page_publi_admin.php
Auteur: Julie STEPHANT
Date de création: 19/04/23
//_____________________________________________
//_____________________________________________
DESCRIPTION:
Page des publications du club sur un compte administrateur
-->
...
<?php
                                if($p['pbl_img'] != NULL){ //si la publication a un média
...
?>
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="<?php echo base_url(). "index.php/publication/supprimer/" . $p['pbl_id']; ?>" onclick="return confirm('Vous vous apprêtez à supprimer la publication de <?php echo $p['pseudo'] ?>, êtes-vous sûr ?');"><i class="fa fa-trash"></i></a></li>
...
<?php
                    ...
                    /*if (count($publications) == 9) { // Si on a récupéré 9 publications, on affiche le bouton 
?>
                        <a href="<?php echo site_url('publication/afficher_admin/'.($offset+9)); ?>">
