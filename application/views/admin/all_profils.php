...
Date de création: 18/04/23
//_____________________________________________
//_____________________________________________
DESCRIPTION:
Page de la liste de tous les profils pour l'administrateur
-->
...
?>
            ...
            <a class="site-btn" href=<?php echo base_url(). "index.php/compte/inscription/"; ?>>Inscrire un membre</a>
        </div>
        <br />
        <br />
        <br />
                        ...
                        echo("<tr class='default-row'>");
                            ...
                            echo("<td>");
                                ...
                                if($role == "administrateur" && $username != $p['pseudo']){
                                    echo("<a class='little-site-btn' href=" . base_url(). 'index.php/administrateur/diminuer_role/' . $p['pseudo'] . "><span class='arrow_carrot-down'></a>");
                                //Si le rôle de la personne est professeur, alors on peut baisser son rôle à membre ou l'augmenter à admin
                                }else if($role == "professeur"){
                                    echo("<a class='little-site-btn' href=" . base_url(). 'index.php/administrateur/diminuer_role/' . $p['pseudo'] . "><span class='arrow_carrot-down'></a>");
                                    echo("<a class='little-site-btn' href=" . base_url(). 'index.php/administrateur/augmenter_role/' . $p['pseudo'] . "><span class='arrow_carrot-up'></a>");
                            ...
                            echo("<td>");
                                ...
                                if($username != $p['pseudo']){
                                    ...
                                    if($role != 'président'){
                                        ...
                                        if($p['pfl_etat'] == 'A'){
                                            echo("<a class='site-btn' href=" . base_url(). 'index.php/administrateur/activer_desactiver/' . $p['pseudo'] . ">Désactiver</a>");
                                        }else{
                                            echo("<a class='site-btn' href=" . base_url(). 'index.php/administrateur/activer_desactiver/' . $p['pseudo'] . ">Activer</a>");
                                        }
                                        ?><a class="site-btn" href=<?php echo base_url(). "index.php/administrateur/supprimer_compte/" . $p['pseudo']; ?> onclick="return confirm('Vous vous apprêtez à supprimer le compte de <?php echo $p['pseudo'] ?>, êtes-vous sûr ?');">Supprimer</a><?php
                                    }
                                }
...
?>
    ...
    <div class="search-model">
        <div class="h-100 d-flex align-items-center justify-content-center">
            ...
            <?php echo form_open('administrateur/list_profils', array('class' => 'search-model-form')); ?>
