<!--
Nom du fichier: profil_admin.php
Auteur: Julie STEPHANT
Date de création: 14/04/23
//_____________________________________________
//_____________________________________________
DESCRIPTION:
Page du profil de l'administrateur connecté
-->
...
?>
    ...
    <section class="product spad">
        <div class="container">
            ...
            <CENTER>
            <h3>Bienvenue sur votre compte administrateur</h3>
            <h6> <?php echo $info_profil->cpt_pseudo; ?> </h6>
            </CENTER>
            <br />
            <br />
            ...
            <div class="col-lg-8 col-md-8 col-sm-8">
                <div class="section-title d-flex align-items-center">
                    ...
                    <a class="site-btn" href=<?php echo base_url(). "index.php/administrateur/modifier_profil/"; ?>>Modifier</a>
                </div>
            </div>
...
<?php 
            ...
            if( $info_profil->pfl_role == 'D'){
                echo("Président du club");
            }else{
                echo("Administrateur");
            }
            echo ("</h4>");
