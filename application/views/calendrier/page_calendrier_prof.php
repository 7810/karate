<!--
Nom du fichier: page_calendrier_prof.php
Auteur: Julie STEPHANT
Date de création: 26/04/23
//_____________________________________________
//_____________________________________________
DESCRIPTION:
Page d'affichage du calendrier du club côté professeur
-->
                    ...
                    <div class = "row">
                        ...
                        <div class="col-sm-2 calendar-items"> 
                            <div class="description-and-buttons">
                                ...
                                // Si l'activité est annulée et qu'elle n'est pas de celui qui est connecté (on va afficher des boutons dans ce cas là)
                                // alors on affiche qu'elle est annulée
                                if($a['act_etat'] == 'X' && $a['pseudo'] != $username){
                                    echo(" (annulé)");
                                }
...
<?php
                                    // Si le pseudo du professeur connecté est le même que le pseudo de l'auteur de l'activité alors on peut afficher les boutons
                                    // Un professeur ne peut modifier et annuler/activer une activité seulement s'il en est l'auteur
                                    if($a['pseudo'] == $username){
                                        if($a['act_etat'] == 'X'){ 
                                            ?><a class="little-site-btn" href=<?php echo base_url(). "index.php/calendrier/annuler_active/" . $a['act_id']; ?>> Activer</a><?php 
                                        }else{ 
                                            ?><a class="little-site-btn" href=<?php echo base_url(). "index.php/calendrier/annuler_active/" . $a['act_id']; ?>> Annuler</a><?php
                                        } 
                                        ?><a class="little-site-btn" href=<?php echo base_url(). "index.php/calendrier/modifier_activite/" . $a['act_id']; ?>><i class="fa fa-pen"></i></a><?php
                                    }
?>
                                </div>
                            </div>
