<!--
Nom du fichier: profil_membre.php
Auteur: Julie STEPHANT
Date de création: 25/04/23
//_____________________________________________
//_____________________________________________
DESCRIPTION:
Page du profil du membre connecté
-->
...
// Si l'utilisateur connecté n'est pas un membre on le redirige vers son profil
...
?>
    ...
    <section class="product spad">
        <div class="container">
            ...
            <CENTER><h3>Bienvenue sur votre compte membre</h3> <h6> <?php echo $info_profil->cpt_pseudo; ?> </h6></CENTER>
            <br />
            <br />
            ...
            <div class="col-lg-8 col-md-8 col-sm-8">
                <div class="section-title d-flex align-items-center">
                    ...
                    <a class="site-btn" href=<?php echo base_url(). "index.php/membre/modifier_profil/"; ?>>Modifier</a>
                </div>
            </div>
